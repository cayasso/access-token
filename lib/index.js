...
AccessToken.prototype.wrap = function create(token) {
  if (!token.expires_at) {
...
AccessToken.prototype.isValid = function(token, fn) {

  var url = this.site + this.userInfoPath;
  var headers = {};
  var qs = {};

  qs[this.accessTokenName] = token.access_token + 1;
...
AccessToken.prototype.getToken = function (token, fn) {
